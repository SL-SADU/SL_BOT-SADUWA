        ...
        if (config.WORKTYPE == 'public') {
            if (config.LANG == 'SI' || config.LANG == 'EN') {
                ...
                if (conn.user.jid === '@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, '*SADU BOT public ආකාරයට ක්‍රියාත්මක විය.❤️*\n\n_කරුණාකර මෙහි command උත්සාහ නොකරන්න. මෙය ඔබගේ ලොග් අංකයයි._\n_ඔබට ඕනෑම චැට් එකක විධාන උත්සාහ කළ හැකිය :)_\n\n*ඔබේ command list එක ලබාගැනීමට .bell command එක භාවිතා කරන්න.*\n\n*ඔබේ bot public ක්‍රියාත්මක වේ. වෙනස් කිරීමට* _.setvar WORK_TYPE:private_ *විධානය භාවිතා කරන්න.*\n\n*github - https://github.com/SL-SADU/SL-SADU-BOTl*\n\n*SADU BOT භාවිතා කිරීම ගැන ස්තූතියි ❤*', MessageType.text);
            ...
            if (config.LANG == 'SI' || config.LANG == 'EN') {
                ...
                await conn.sendMessage(conn.user.jid, '*SADU BOT private ආකාරයට ක්‍රියාත්මක විය.❤️*\n\n_කරුණාකර මෙහි command උත්සාහ නොකරන්න. මෙය ඔබගේ ලොග් අංකයයි._\n_ඔබට ඕනෑම චැට් එකක විධාන උත්සාහ කළ හැකිය :)_\n\n*ඔබේ command list එක ලබාගැනීමට .bell command එක භාවිතා කරන්න.*\n\n*ඔබේ bot private ක්‍රියාත්මක වේ. වෙනස් කිරීමට* _.setvar WORK_TYPE:public_ *විධානය භාවිතා කරන්න.*\n\n*https://github.com/SL-SADU/SL-SADU-BOT*\n\n*SADU_BOTl භාවිතා කිරීම ගැන ස්තූතියි ❤*', MessageType.text);
                }
            }
            else {
                ...
                if (conn.user.jid === '@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, '*SADU_BOTl private ආකාරයට ක්‍රියාත්මක විය.❤️*\n\n_කරුණාකර මෙහි command උත්සාහ නොකරන්න. මෙය ඔබගේ ලොග් අංකයයි._\n_ඔබට ඕනෑම චැට් එකක විධාන උත්සාහ කළ හැකිය :)_\n\n*ඔබේ command list එක ලබාගැනීමට .bell command එක භාවිතා කරන්න.*\n\n*ඔබේ bot private ක්‍රියාත්මක වේ. වෙනස් කිරීමට* _.setvar WORK_TYPE:public_ *විධානය භාවිතා කරන්න.*\n\n*https://github.com/SL-SADU/SL-SADU-BOT*\n\n*SADU_BOT භාවිතා කිරීම ගැන ස්තූතියි ❤*', MessageType.text);
                }
            }
        }
        else {
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (config.LANG == 'SI' || config.LANG == 'EN') {
                                await conn.sendMessage(conn.user.jid, '*📵 දෝෂ වාර්තාව [SADU_BOT] 📵*' + 
                                ...
                                await conn.sendMessage(conn.user.jid, '*📵 බොට් වාර්තාව [SADU_BOT] 📵*' + 
                                ...
                                await conn.sendMessage(conn.user.jid, '*👸💃SL_SADU_BOT*' + 
                                    '\n\n*hello im SADHU BOT*'+
                                    '\n\n_Message logs ඔබගේ අංකය හෝ ප්‍රති පාර්ශ්වයේ අංකය අඩංගු විය හැකිය. කරුණාකර එය සමග සැලකිලිමත් වන්න!_' +
                                    '\n\n_උදව් සඳහා ඔබට අපගේ whatsapp support කණ්ඩායමට ලිවිය හැකිය._' +
                                    '\n\n_(සුරකින ලද පණිවිඩ)_' +
